...
__all__ = [
    ...
    'resnet18_bn', 'resnet34', 'resnet50_bn', 'resnet101',

     'retinanet_fpn', 'retinanet_fpn101',

    'vgg19_bn_lb', 'vgg19_bn_4','vgg19_bn_8','vgg19_bn_16','vgg19_bn_32',
     'vgg19_4','vgg19_8','vgg19_16','vgg19_32',
    'resnet18preAct_bn_4','resnet18preAct_bn_8','resnet18preAct_bn_16','resnet18preAct_bn_32'
]
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, batch_norm=True):
        super(BasicBlock, self).__init__()
        self.batch_norm = batch_norm
        if norm_layer is None and self.batch_norm:
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
                 ...
                 norm_layer=None, batch_norm=True):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample, self.groups,
                            self.base_width, previous_dilation, norm_layer, self.batch_norm))
...
def resnet18preact_bn_4(num_classes=10, seed=None, dropout=False) -> PreActResNet:
...
def resnet18(pretrained=False, progress=True, dropout=False, seed=None, **kwargs):
...
def resnet18_bn(pretrained=False, progress=True, dropout=False, seed=None, **kwargs):
    r"""ResNet-18 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
...
def resnet34_bn(pretrained=False, progress=True, dropout=False, seed=None, **kwargs):
...
def resnet50_bn(pretrained=False, progress=True, dropout=False, seed=None,**kwargs):
...
def resnet50(pretrained=False, progress=True, dropout=False, seed=None,**kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
...
def resnet101_bn(pretrained=False, progress=True, dropout=False, seed=None, **kwargs):
